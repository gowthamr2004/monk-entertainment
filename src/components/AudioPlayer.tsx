...
const AudioPlayer = ({ currentSong, queue, onNext, onPrevious }: AudioPlayerProps) => {
  ...
  return (
    <div className="audio-player fixed bottom-16 md:bottom-0 left-0 md:left-[200px] lg:left-[260px] xl:left-[280px] right-0 z-50 bg-card border-t border-border shadow-2xl">
      <audio
        ref={audioRef}
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="hover:bg-muted h-9 w-9 md:h-10 md:w-10"
            >
            ...
            <Button
              size="icon"
              variant="default"
              className="w-10 h-10 md:w-11 md:h-11 rounded-full hover-glow shadow-lg"
              onClick={togglePlay}
            >
              {isPlaying ? (
